...
# [1.12.0] - 2020-08-13
### Changed
- Identity and Correlation Cookies to `Secure` 

# [1.11.2] - 2020-07-24
### Added
- `AcceptedTermsOfService` Field
    - Accept TOS On new Paddle Subscription

# [1.11.1] - 2020-07-23
### Added
- Ability to persist cookies over restarts

## [1.11.0] - 2020-07-22
### Changed
- Remove authentication requirement for getting Subscription information
### Added
- IdentityController for multiple SteamIds
- Situation Feedback endpoint

## [1.10.0] - 2020-06-23
### Changed
- Controllers for dashboard endpoints to return full data when demo profile is visited
